...
[theme~="dark"] {
  --lumo-base-color: #317d9f;
  --lumo-primary-color-50pct: rgba(15, 100, 137, 0.5);
  --lumo-primary-color-10pct: rgba(15, 100, 137, 0.1);
  --lumo-primary-color: #0F6489;
  --lumo-primary-text-color: rgb(15, 100, 137);
}
  </style>
</custom-style>
